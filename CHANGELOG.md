...
## [Unreleased]
- Fixed: Invalid internal name of the `newExpressionDoesNotUseClassicHistogramBucketOperations` validator causing that it wasnt possible to disable the validator
