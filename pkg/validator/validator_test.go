...
var testCases = []struct {
	...
	{name: "ruleLabelMatchesRegexpNegate", validator: labelMatchesRegexp{label: "foo", regexp: regexp.MustCompile(`\d+`), negate: true}, rule: rulefmt.Rule{Labels: map[string]string{"foo": "bar"}}, expectedErrors: 0},
	{name: "ruleLabelMatchesRegexpNegateFail", validator: labelMatchesRegexp{label: "foo", regexp: regexp.MustCompile(matchAnythingRegexp), negate: true}, rule: rulefmt.Rule{Labels: map[string]string{"foo": "bar"}}, expectedErrors: 1},
	...
	{name: "ruleAnnotationMatchesRegexpNegate", validator: annotationMatchesRegexp{annotation: "foo", regexp: regexp.MustCompile(`\d+`), negate: true}, rule: rulefmt.Rule{Annotations: map[string]string{"foo": "bar"}}, expectedErrors: 0},
	{name: "ruleAnnotationMatchesRegexpNegateFail", validator: annotationMatchesRegexp{annotation: "foo", regexp: regexp.MustCompile(matchAnythingRegexp), negate: true}, rule: rulefmt.Rule{Annotations: map[string]string{"foo": "bar"}}, expectedErrors: 1},
	...
	{name: "ruleHasNoLabelWithAllowedValue", validator: labelHasAllowedValue{label: "foo", allowedValues: []string{"bar"}}, rule: rulefmt.Rule{}, expectedErrors: 0},
	{name: "ruleHasEmptyLabelWithAllowedValue", validator: labelHasAllowedValue{label: "foo", allowedValues: []string{"bar"}}, rule: rulefmt.Rule{Labels: map[string]string{"foo": ""}}, expectedErrors: 1},
	...
	{name: "ruleHasNoAnnotationWithAllowedValue", validator: annotationHasAllowedValue{annotation: "foo", allowedValues: []string{"bar"}}, rule: rulefmt.Rule{}, expectedErrors: 0},
	{name: "ruleHasEmptyAnnotationWithAllowedValue", validator: annotationHasAllowedValue{annotation: "foo", allowedValues: []string{"bar"}}, rule: rulefmt.Rule{Annotations: map[string]string{"foo": ""}}, expectedErrors: 1},
	...
	{name: "ruleExprDoesNotUseAnyLabels", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel, "label_app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelector", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app=~'foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelector", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexp", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_.*_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexpExtraAnchors", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("^kube_.*_labels$")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexpNotFullMatch", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_.*_label")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexp", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "{__name__=~'kube_.*_labels', app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInBy", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "sum(kube_pod_labels) by (app)"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInOn", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) up"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInGroup", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "group(kube_pod_labels) by (label_app)"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer1", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_left(foo) up"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer2", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: labelsMap([]string{metricNameLabel}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_right(foo) up"}, expectedErrors: 2},

	// expressionDoesNotUseLabelsForMetricRegexp
	{name: "ruleExprDoesNotUseAnyLabels", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"label_app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelector", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app=~'foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelector", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexp", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_.*_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexpExtraAnchors", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app"}), metricNameRegexp: mustCompileAnchoredRegexp("^kube_.*_labels$")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexpNotFullMatch", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{}), metricNameRegexp: mustCompileAnchoredRegexp("kube_.*_label")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexp", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "{__name__=~'kube_.*_labels', app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInBy", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "sum(kube_pod_labels) by (app)"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInOn", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) up"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInGroup", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"label_app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "group(kube_pod_labels) by (label_app)"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer1", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_left(foo) up"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer2", validator: expressionDoesNotUseLabelsForMetricRegexp{labels: labelsMap([]string{"app", "foo"}), metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_right(foo) up"}, expectedErrors: 2},

	// expressionUsesOnlyAllowedLabelValuesForMetricRegexp
	{name: "ruleExprDoesNotUseAnyLabels", validator: expressionUsesOnlyAllowedLabelValuesForMetricRegexp{allowedLabelValues: map[string][]string{"foo": {"bar"}}, metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels"}, expectedErrors: 0},
	{name: "ruleExprDoesNotUseForbiddenLabelValue", validator: expressionUsesOnlyAllowedLabelValuesForMetricRegexp{allowedLabelValues: map[string][]string{"foo": {"bar"}}, metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{foo='bar'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelValue", validator: expressionUsesOnlyAllowedLabelValuesForMetricRegexp{allowedLabelValues: map[string][]string{"foo": {"bar"}}, metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{foo='bar2'}"}, expectedErrors: 1},
	{name: "ruleExprDoesNotUseForbiddenLabelValueInRegexpMatcher", validator: expressionUsesOnlyAllowedLabelValuesForMetricRegexp{allowedLabelValues: map[string][]string{"foo": {"barbar"}}, metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{foo=~'bar.*'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelValueInRegexpMatcher", validator: expressionUsesOnlyAllowedLabelValuesForMetricRegexp{allowedLabelValues: map[string][]string{"foo": {"bar"}}, metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{foo=~'barbar.*'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseNegativeMatcher", validator: expressionUsesOnlyAllowedLabelValuesForMetricRegexp{allowedLabelValues: map[string][]string{"foo": {"bar"}}, metricNameRegexp: mustCompileAnchoredRegexp("kube_pod_labels")}, rule: rulefmt.Rule{Expr: "kube_pod_labels{foo!='bar1', foo!~'bar.+'}"}, expectedErrors: 0},
	...
	{name: "alertNameMatchesRegexpNegate", validator: alertNameMatchesRegexp{pattern: regexp.MustCompile("Foo.*"), negate: true}, rule: rulefmt.Rule{Alert: `Bar`}, expectedErrors: 0},
	{name: "alertNameMatchesRegexpNegateFail", validator: alertNameMatchesRegexp{pattern: regexp.MustCompile("Foo.*"), negate: true}, rule: rulefmt.Rule{Alert: `FooBAr`}, expectedErrors: 1},
	...
	{name: "recordedMetricNameMatchesRegexpNegate", validator: recordedMetricNameMatchesRegexp{pattern: regexp.MustCompile("[^:]+:[^:]+:[^:]+"), negate: true}, rule: rulefmt.Rule{Record: `foo_bar`}, expectedErrors: 0},
	{name: "recordedMetricNameMatchesRegexpNegateFail", validator: recordedMetricNameMatchesRegexp{pattern: regexp.MustCompile("[^:]+:[^:]+:[^:]+"), negate: true}, rule: rulefmt.Rule{Record: `cluster:foo_bar:avg`}, expectedErrors: 1},
	...
	{name: "groupNameMatchesRegexpNegate", validator: groupNameMatchesRegexp{pattern: regexp.MustCompile(`^[A-Z]\S+$`), negate: true}, group: unmarshaler.RuleGroup{Name: "Test Group"}, expectedErrors: 0},
	{name: "groupNameMatchesRegexpNegateFail", validator: groupNameMatchesRegexp{pattern: regexp.MustCompile(`^[A-Z]\S+$`), negate: true}, group: unmarshaler.RuleGroup{Name: "TestGroup"}, expectedErrors: 1},
