...
var testCases = []struct {
	...
	{name: "ruleExprDoesNotUseAnyLabels", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{"label_app"}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelector", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app=~'foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelector", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexp", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_.*_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexpExtraAnchors", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "^kube_.*_labels$"}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexpNotFullMatch", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_.*_label"}, rule: rulefmt.Rule{Expr: "kube_pod_labels{app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInSelectorWithMetricNameAsRegexp", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "{__name__=~'kube_.*_labels', app='foo'}"}, expectedErrors: 0},
	{name: "ruleExprDoesUseForbiddenLabelInBy", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "sum(kube_pod_labels) by (app)"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInOn", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) up"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInGroup", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "group(kube_pod_labels) by (label_app)"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_left(foo) up"}, expectedErrors: 2},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_right(foo) up"}, expectedErrors: 2},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{"app"}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_left(foo) up"}, expectedErrors: 1},
	{name: "ruleExprDoesUseForbiddenLabelInBinaryExprWithLabelTransfer", validator: expressionUsesOnlyAllowedLabelsForMetricRegexp{allowedLabels: []string{"app"}, metricNameRegexp: "kube_pod_labels"}, rule: rulefmt.Rule{Expr: "kube_pod_labels * on(app) group_right(foo) up"}, expectedErrors: 1},
